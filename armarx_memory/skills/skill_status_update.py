...
from armarx_memory.skills import dto, dti
from armarx_memory.skills.skill_id import SkillID, SkillIdConv
...
class SkillStatusUpdateHeader:
    ...
    used_callback_interface: dti.SkillProviderCallbackInterfacePrx
