...
def run_bimanual_adm_ctrl(
        robot: Robot,
        config_filename: str = None,
        from_aron: bool = True,
):
    config = TaskspaceAdmittanceControllerConfig().from_json(config_filename) if from_aron else config_filename

    control_type = ControllerType.TSAdmittance
    ...
    try:
        _cfg: TaskspaceAdmittanceControllerConfig
        ...
        for i in range(n_steps):
            ...
            config: TaskspaceAdmittanceControllerConfig = robot.get_controller_config(controller_name)
...
def main(from_aron: bool):
    ...
    run_bimanual_adm_ctrl(robot, str(p), from_aron)
